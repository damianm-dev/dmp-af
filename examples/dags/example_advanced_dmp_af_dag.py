...
from dmp_af.conf import Config, DbtDefaultTargetsConfig, DbtProjectConfig, RetriesConfig, RetryPolicy
from dmp_af.dags import compile_dmp_af_dags

# specify here all settings for your dbt project
config = Config(
    dbt_project=DbtProjectConfig(
        dbt_project_name='dmp_af_project',
        dbt_project_path='/opt/airflow/dags',
        dbt_models_path='/opt/airflow/dags/advanced_jaffle_shop/dbt/models',
